...
def _generate_outline_with_llm(
    ...
    prompt = (
        ...
        "- Use a logical arc: context -> methods/approach -> findings/"
...
def _section_key_points(
    ...
    templates = [
        ...
        "Compare viewpoints that shape this section.",
        "Outline why these points matter for the final report.",
    ]
...
def _repair_outline_with_llm(
    ...
    prompt = (
        ...
        "Flow requirement: ensure sections form a connected narrative from "
        "opening context to final synthesis.\n"
        "Previous JSON:\n"
        + payload_json
        + "\n\n"
        "Do not include markdown, no backticks, no commentary.\n"
