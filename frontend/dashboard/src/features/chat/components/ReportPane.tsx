  ...
  return (
    <div className="flex w-[55%] min-h-0 flex-col bg-slate-950">
      ...
      <div className="flex flex-wrap gap-3 border-b border-slate-800 px-8 py-4">
        <button onClick={onExport} disabled={report.sections.length === 0} className={REPORT_ACTION_BUTTON_CLASSES}>
          <Download className="h-4 w-4" />
          Export
        </button>
        <button onClick={onClear} disabled={report.sections.length === 0} className={REPORT_ACTION_BUTTON_CLASSES}>
          <Trash2 className="h-4 w-4" />
          Clear
        </button>
        <button onClick={onShare} disabled={report.sections.length === 0} className={REPORT_ACTION_BUTTON_CLASSES}>
